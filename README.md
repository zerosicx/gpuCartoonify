...
* Using the Git command line interface
        ...
        Alternatively, you could get the project from GitLab repository using IntelliJ interface (Get a project from version control: https://www.jetbrains.com/help/idea/import-project-or-module-wizard.html)
